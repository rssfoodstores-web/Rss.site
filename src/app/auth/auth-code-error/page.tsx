    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen py-2 px-4 text-center">
            ...
            <div className="mb-6 max-w-2xl space-y-3 text-sm text-gray-600">
                ...
                <p>Also make sure you start Google signin and finish the callback on the same host and port. For example, do not start on <span className="font-mono">localhost:3000</span> and return on <span className="font-mono">127.0.0.1:3000</span> or a LAN IP.</p>
            </div>
